...
func TestWalletManager_EthGetTransactionByHash(t *testing.T) {
	...
	//txid := "0x4241fa7e03a8beb4f0a0fa063a2fc504b98662b11feb06720bb97aaca2393391"
	txid := "0x1c624ba9391eaf956b156177ef16ee5fbcc303ec4e07dae82bf9c9679f418a1b"
...
func TestWalletManager_ethGetTransactionReceipt(t *testing.T) {
	wm := testNewWalletManager()
	txid := "0x1b088e2ccd2e409ccb001af28961b5b1c8d7b132942f3adcd430b77d15e0444f"
...
func TestWalletManager_EthGetBlockByNum(t *testing.T) {
	wm := testNewWalletManager()
	block, err := wm.GetBlockByNum(913062, false)
	if err != nil {
		t.Errorf("GetBlockByNum failed, err=%v", err)
		return
	}
