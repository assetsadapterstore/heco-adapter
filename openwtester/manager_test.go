...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO HT", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "W6pCLPenzu1XuHx9gazjitoyUXNoJnkapj")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "W6pCLPenzu1XuHx9gazjitoyUXNoJnkapj"
	account := &openwallet.AssetsAccount{Alias: "HT", WalletID: walletID, Required: 1, Symbol: "HT", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "W6pCLPenzu1XuHx9gazjitoyUXNoJnkapj"
	//accountID := "5ry4GxRf3QosSFZ9e1ouj4duCrTpMstoSKJ2MPmyfFsk"
	accountID := "7RXSNLgioaamTpJbswxDEXA3AADCeNMsz4UF9gb5hihD"
